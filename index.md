...
<img src="photo.jpg" alt="Юлия Свободина" width="240"/>
...
### Online Store(frontend for further integration with the server) ###

Стек: React, JavaScript, API  

Я разрабатываю приложение для электронной коммерции на основе React со списком товаров и функциональностью корзины покупок. 
Реализованы повторно используемые компоненты макета и базовая структура пользовательского интерфейса. 
В настоящее время я работаю над логикой приложения, управлением состоянием и расширением функциональности для интеграции интерфейса с сервером.

[Live](https://online-store-front-kappa.vercel.app/)|[GitHub](https://github.com/Jul-svoboda/online-store.git)
